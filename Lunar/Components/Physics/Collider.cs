        ...
        public void MoveTransform(Side side, Transform global, Transform collider)
        {
            ...
            switch (side)
            {
                case Side.TOP:
                    ...
                    Transform.MoveTransform(_id, new Vertex2f(0, topB - bottomA));
                    break;
                ...
                case Side.BOTTOM:
                    ...
                    Transform.MoveTransform(_id, new Vertex2f(0, bottomB - topA));
                    break;
                ...
                case Side.LEFT:
                    ...
                    Transform.MoveTransform(_id, new Vertex2f(leftB - rightA, 0));
                    break;
                ...
                case Side.RIGHT:
                    ...
                    Transform.MoveTransform(_id, new Vertex2f(rightB - leftA, 0));
                    break; 
            }
        }
